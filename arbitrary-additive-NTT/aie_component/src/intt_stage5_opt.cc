    ...
    //===================================================//
       ...
       //============================== //
        ...
        //=====================================// 
            ...
            aie::vector<int32,16> temp_a1 = readincr_v<16>(cb_input);
            aie::vector<int32,16> temp_b1 = readincr_v<16>(cb_input);
            aie::vector<int16,32> a1 = as_v32int16(temp_a1); 
            aie::vector<int16,32> b1 = as_v32int16(temp_b1); 
            aie::vector<int16,16> a1_high = aie::filter_odd (a1);
            aie::vector<int16,16> a1_low =  aie::filter_even(a1);
            aie::vector<int16,16> b1_high = aie::filter_odd (b1);
            aie::vector<int16,16> b1_low =  aie::filter_even(b1);


            std::pair<aie::vector<int16,16>,aie::vector<int16,16>> r1 = aie::interleave_zip(b1_high,a1_high,1);
            std::pair<aie::vector<int16,16>,aie::vector<int16,16>> r2 = aie::interleave_zip(b1_low,a1_low,1);

            aie::vector<int32, 8> res1_first = as_v8int32(r1.first);
            aie::vector<int32, 8> res1_second = as_v8int32(r1.second);

            aie::vector<int32, 8> res2_first = as_v8int32(r2.first);
            aie::vector<int32, 8> res2_second = as_v8int32(r2.second);
