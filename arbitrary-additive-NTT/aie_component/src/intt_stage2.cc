	...
	output_stream_uint32 * cb_output)
{
    ...
    chess_loop_range(32,)    
    {
       ...
       b[1] = readincr(cb_input);          
        ...
        // printf("before a[0]=%d",a[0]);
        // printf("before a[1]=%d",a[1]);
        // printf("before b[0]=%d",b[0]);
        // printf("before b[1]=%d",b[1]);

       exchange1(&a[0],&b[0]);
       exchange2(&a[1],&b[1]); // Mark here July.18. There should be some ways to further improve the throughput?? 
       
        // printf("after a[0]=%d",a[0]);
        // printf("after a[1]=%d",a[1]);
        // printf("after b[0]=%d",b[0]);
        // printf("after b[1]=%d\n",b[1]);
